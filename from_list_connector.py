...
class Computer:
    ...
    def __enter__(self):
        ...
        cell_conn = p.FromListConnector(create_conn_list(self.width, self.height, self.weight), safe=True)      
        p.Projection(input_pop, mid_pop, cell_conn, receptor_type='excitatory')
